...
class Product(models.Model):
    ...
    category = models.ForeignKey(Category, blank=False, verbose_name=_("Category"), default=None)
    ...
    active = models.IntegerField(_("Active"), default=1, help_text=_("This will determine whether a product should be active for display or not"))
    ...
    view = models.IntegerField("View", default=1, blank=True, help_text="Count views of a particular product")
